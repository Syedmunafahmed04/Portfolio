...
class Web_Homepage extends StatefulWidget {
  const Web_Homepage({super.key});

  @override
  State<Web_Homepage> createState() => _Web_HomepageState();
}

class _Web_HomepageState extends State<Web_Homepage> {
                      ...
                      child: Column(
                        children: [
                          ...
                          Padding(
                            ...
                            child: AutoSizeText(
                              """As a novice Flutter developer, I'm eager to craft visually
appealing and intuitive UIs despite my limited experience
Passionate about learning and growth, I focus on creating
engaging designs with a fresh perspective.
